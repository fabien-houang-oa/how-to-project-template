...
1. worldcities.csv is a csv file containing a list of cities for the master table that was downloaded at [https://simplemaps.com/data/world-cities](https://simplemaps.com/data/world-cities).
